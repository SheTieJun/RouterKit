...
object ClassMatchKit {
    ...
    private val DEFAULT_EXCLUDE_JAR = arrayListOf(
        ...
        "core-runtime",
        "lifecycle-common", "jetified-annotation-experimental",
    ...
    fun checkHasServiceImpl(reader: ClassReader): Boolean {
        return InterfaceImplChecked.hasImplInterfacesSim(reader, setOf(MODULE_SERVICE_INTERFACE,MODULE_SERVICE_INTERFACE_2))
    }
